...
class DodajOrganizacjeCommandTest extends TestCase
{
    ...
    {
        $this->assertEquals('app.command.organizacja.dodaj', $this->command->messageName());
    ...
    public function getCommand(){
        ...
        $this->command = new DodajOrganizacjeCommand($this->tokenStorage);
    }
}
